...
echo "PWDFILE='/root/.ipython/profile_default/nbpasswd.txt'" >> /root/.ipython/profile_default/nbpasswd.txt
echo "c.NotebookApp.password = open(PWDFILE).read().strip()" >> /root/.ipython/profile_default/nbpasswd.txt
