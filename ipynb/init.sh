...
echo "PWDFILE='/root/.ipython/profile_default/nbpasswd.txt'" >> /root/.ipython/profile_default/ipython_notebook_config.py
echo "c.NotebookApp.password = open(PWDFILE).read().strip()" >> /root/.ipython/profile_default/ipython_notebook_config.py
